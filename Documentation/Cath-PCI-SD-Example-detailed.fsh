...
* administration.event 1..1 Coding "EventCode" "Code used for reason of submission"
...
* administration.status  1..1 Coding "Submission Status" "Status of the Submission, always final"
...
* administration.type  1..1 Coding "Submission Type" "Submission Type, always Episode of Care Record"
