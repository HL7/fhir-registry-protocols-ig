...
* rest[serverSlice].resource[StructureMapSlice].interaction[2].code = #create
* rest[serverSlice].resource[StructureMapSlice].interaction[2].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[serverSlice].resource[StructureMapSlice].interaction[2].extension.valueCode = #SHALL

* rest[serverSlice].resource[StructureMapSlice].interaction[3].code = #update
* rest[serverSlice].resource[StructureMapSlice].interaction[3].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[serverSlice].resource[StructureMapSlice].interaction[3].extension.valueCode = #SHALL
