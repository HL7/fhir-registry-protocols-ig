...
%JAVAEXE% -classpath %SAXONCP% net.sf.saxon.Transform -s:CREDS.xml -xsl:index.xslt
%JAVAEXE% -classpath %SAXONCP% net.sf.saxon.Transform -s:CREDS.xml -xsl:overview.xslt
%JAVAEXE% -classpath %SAXONCP% net.sf.saxon.Transform -s:CREDS.xml -xsl:actorsandtransactions.xslt
popd